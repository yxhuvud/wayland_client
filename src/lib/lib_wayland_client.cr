module WaylandClient
  ...
  lib LibWaylandClient
    ...
    fun wl_subsurface_set_position = wl_subsurface_set_position_shim(Pointer(WlSubsurface), LibC::Int, LibC::Int) : Void
    ...
    fun wl_pointer_set_cursor = wl_pointer_set_cursor_shim(Pointer(WlPointer), LibC::UInt, Pointer(WlSurface), LibC::Int, LibC::Int) : Void
